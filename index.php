...
<head>
    ...
    <!-- Favicon -->
    <link href="config_index/img/favicon.ico" rel="icon">
    ...
    <link href="config_index/lib/animate/animate.min.css" rel="stylesheet">
    <link href="config_index/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="config_index/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="config_index/css/style.css" rel="stylesheet">
</head>
...
<body>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h2 class="mb-4">Empresa enfocada en soluciones tecnológicas para la gestión eficiente de la documentación.</h2>
    ...
    <script src="config_index/lib/wow/wow.min.js"></script>
    <script src="config_index/lib/easing/easing.min.js"></script>
    <script src="config_index/lib/waypoints/waypoints.min.js"></script>
